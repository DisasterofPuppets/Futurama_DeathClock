...
{
  if (strcmp(data.custom_reward_id, DC_ID) == 0) {
    printf("\n Hey someone wants to know when they die bro");

      // HERE IS WHERE YOU PUT CHATBOT FEEDBACK CODES
    char soundpls[30] = {"/w drpuppetmaster !dcredeem"};
    twitch_api.send_chat_message(soundpls); 
